...
<body>
    <div class="col-lg-12">
        <div class="container card-header text-center card border-dark mb-3">
            ...
            <table class="borda">
                ...
                <tr>
                    <td colspan="2"><b>Olá! <?php echo "{$logado}"; ?></b><br><br>
                        <b> A Cesta Assiduidade ainda não está disponivel </b>
                        <!--<b>Neste mês não foram preenchidos os requisitos para o recebimento do prêmio assiduidade.<b><br><br></td>-->
                </tr>
            </table>
        </div>
    </div>
